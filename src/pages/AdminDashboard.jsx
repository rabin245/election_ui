  ...
  return (
    <div className="mainDiv">
      ...
      >
        ...
        <hr className="bg-gray-600 h-px border-0 my-2" />
        ...
        <div className="p-2 flex items-center text-white cursor-pointer px-4 hover:bg-blue-600 rounded-md mt-3">
          ...
          <span className="font-bold text-gray-200 text-xl ml-4">Home</span>
        </div>
        <div className="p-2 flex items-center text-white cursor-pointer px-4 hover:bg-blue-600 rounded-md mt-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="font-bold text-gray-200 text-xl ml-4">Results</span>
        </div>
        ...
        <div className="p-2 flex items-center text-white cursor-pointer px-4 hover:bg-blue-600 rounded-md mt-3">
          ...
          <span className="font-bold text-gray-200 text-xl ml-4">Logout</span>
        </div>
      </div>
